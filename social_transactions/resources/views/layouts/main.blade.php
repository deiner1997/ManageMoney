...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Laravel Social Transactions</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-toggleable-xs" id="collapseEx">
                ...
                <ul class="nav navbar-nav">
                    ...
                    @if(!Auth::check())
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('login') }}"><i class="fa fa-sign-in"></i> Iniciar sesión</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('register') }}"><i class="fa fa-registered"></i> Registrar se</a>
                    </li>
                    @else
                    <li class="nav-item">
